...
const BookmarkedTvseries = () => {
  ...
  const getData = async () => {
    ...
    const datA = data.results.slice(0, 3);
      ...
      {results.map((movie, index) => {
        ...
        return (
          ...
          >
            ...
            <div className="absolute right-[8px] top-[8px]  md:right-[16px] md:top-[16px] bg-[#10141e] text-white w-[32px] h-[32px] rounded-full flex items-center justify-center ">
              <FaBookmark />
            </div>
